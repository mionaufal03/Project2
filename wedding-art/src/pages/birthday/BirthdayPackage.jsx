...
const BirthdayPackage = () => {
  ...
  const packageDetails = {
    ...
    price: "250",
    details:
      "From cake-cutting to party games, we’ll document every joyful moment of your special day. Whether it’s a child’s first birthday or a milestone celebration, we’ll make sure the moments are unforgettable.",
    images: [
